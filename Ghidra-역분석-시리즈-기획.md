...
| # | 제목 | 핵심 내용 | 상태 |
|---|------|----------|------|
| 1 | 왜 역분석을 하게 됐나 | 소스코드 분실, 현장 업데이트 필요 | |
| 2 | HEX 파일 구조 이해하기 | Intel HEX 포맷, 주소 계산 | |
| 3 | Ghidra 설치와 첫 로드 | ARM Cortex-M 설정, 메모리 맵 | |
| 4 | 디스어셈블리 vs 디컴파일 | 어셈블리 읽기, C 유사 코드 해석 | |

## Part 2: STM32 구조 분석편

| # | 제목 | 핵심 내용 | 상태 |
|---|------|----------|------|
| 5 | Vector Table 분석 | Reset_Handler 찾기, SP 초기값 | |
| 6 | 메모리 맵 추정하기 | Flash/RAM 영역, 주변장치 주소 | |
| 7 | 부트로더 경계 찾기 | 16KB 확인, 앱 시작 주소 | |

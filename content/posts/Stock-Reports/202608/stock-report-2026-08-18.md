...
**핵심: 유가는 이란 강경 발언에 반등(WTI +3%), 금은 $4,450으로 재상승. 장기금리가 뛰는데 금이 같이 오른다는 건, 시장이 '실질금리'가 아니라 '재정 신뢰'를 걱정한다는 뜻이다.**

| 원자재 | 가격 (8/17~18) | 변동 | 비고 |
|--------|---------------|------|------|
| 브렌트유 | $88~91 | 상승 | 이란 조건부 발언에 재반등 |
| WTI | $84.95 | +3.1% | 하루 3% 급등, $85 회복 |
| 금 | $4,451.90 | +0.33% | $4,400 지지 후 재상승 |
...
- 유가는 $80대가 바닥. 봉쇄가 물리적으로 유지되는 한 하방 경직성이 강하다. 다만 협상 헤드라인 하나에 $5씩 움직이는 구간이라 에너지주 단기 트레이딩은 리스크가 크다.
- 금 비중은 유지가 맞다. 인플레 3.4% + 30년물 5.3% + 전쟁 미해결 조합에서 안전자산을 비우는 건 성급하다.
